...
| **Proactive（主动推送）** | Agent对用户需求与兴趣的分析，对新建知识、连接到的新通知或消息的快速总结     | 洞察建议、主动提醒       |
...
**这就是金融场景下 ReMe 的核心价值**：分析师只负责"看 + 说"，知识图谱自己长出来；当感知到重要新消息时，ReMe 主动把"新事件 ↔ 旧上下文"的连线送到分析师面前。
